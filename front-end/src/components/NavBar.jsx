  ...
  return (
    <div className="relative flex flex-col h-full w-full">
      ...
      <div
        ...
        className={`absolute top-0 left-0 w-64 bg-gray-400 text-black h-full transform ${
          open ? "translate-x-0 " : "-translate-x-full"
        } transition-transform duration-700`}
      >
        <button className="text-2xl p-4" onClick={handleDrawerToggle}>
          <CancelOutlinedIcon className="transition-transform duration-300 hover:scale-105 hover:text-red-500" />
        </button>
